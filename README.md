...
| Folder | Dataset | Primary source | Credit / donor | License shown by source |
|---|---|---|---|---|
| `datasets/obesity/` | Estimation of Obesity Levels Based On Eating Habits and Physical Condition | UCI Machine Learning Repository | Fabio Mendoza Palechor; Alexis de la Hoz Manotas | CC BY 4.0 |
| `datasets/breast_cancer/` | Breast Cancer Wisconsin (Diagnostic) | UCI Machine Learning Repository | William H. Wolberg; W. Nick Street; Olvi L. Mangasarian. Donor: Nick Street | CC BY 4.0 |
| `datasets/heart_disease/` | Heart Disease | UCI Machine Learning Repository | Andras Janosi; William Steinbrunn; Matthias Pfisterer; Robert Detrano. Historical UCI donor attribution: David W. Aha | CC BY 4.0 |
...
| `datasets/thyroid/` | Thyroid Disease | UCI Machine Learning Repository | Garavan Institute; documentation/creator attribution: Ross Quinlan | CC BY 4.0 |
| `datasets/covid19/` | COVID-19 Symptoms Checker | Kaggle | Bilal Hungund | GPL 2 |
