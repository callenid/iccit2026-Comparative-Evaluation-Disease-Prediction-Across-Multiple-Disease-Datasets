...
> **Research use:** The datasets included in this repository were used in the research paper *Comparative Evaluation of Machine Learning Models for Symptom-Based Disease Prediction Across Multiple Disease Datasets by Calandra, Joshua, David, Hery, Andree, Arnold*.
